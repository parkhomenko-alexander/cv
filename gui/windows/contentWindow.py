...
class ContentWindow(QWidget):
    ...
    def initUI(self):
        ...
        scr_shot_button = QPushButton(icon=QIcon('icons/748046.png'))
        scr_shot_button.setToolTip("Get_screenshots")
        scr_shot_button.clicked.connect(self.screenshot1)
        ...
        scr_shot_button = QPushButton("scr_shot", self)
        scr_shot_button.clicked.connect(self.screenshot1)

        button_layout.addWidget(image_button)
        button_layout.addWidget(video_button)
        button_layout.addWidget(scr_shot_button)
        button_layout.addWidget(scr_shot_button)
